    ...
    <div>
		...
		<section class="data_section">
            ...
            <el-row :gutter="20">
                ...
                <!-- <el-col :span="4"><div class="data_list"><span class="data_num">{{testData}}</span> 管理员</div></el-col> -->
            </el-row>
		</section>
...
<script>
    ...
    import {userCount, orderCount, getUserCount, getOrderCount, adminDayCount, adminCount,testData} from '@/api/getData'
    export default {
    	data(){
    		return {
    			userCount: null,
    	...
    	methods: {
    		async initData(){
    			...
    			Promise.all([userCount(today), orderCount(today), adminDayCount(today), getUserCount(), getOrderCount(), adminCount(),testData()])
